...
\bigskip
In IoT systems it is common to deal with a lot of high data rate communication involving constrained devices, having limited (sometimes extremely limited) power.\\
For this reason, we need some standard providing low-latency with low-energy consumption even at lower bandwidths.\\

More in details, these are the requirements for a network composed by a relevant number of constrained devices:
...
\item[$\bullet$] granting a good quality of reliable services
