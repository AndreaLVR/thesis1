...
Talking about the first one, there is an interesting metholody proposed by Microsoft, called \emph{Security Development Lifecycle (SDL)~}, which provides a standard approach for security development.\\
The classic software development lifecycle involves:
\begin{itemize}
  \item Requirements
  \item Design
  \item Implementation
