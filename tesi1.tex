...
Currently, ZigBee is mainly used to build Smart Homes.\\
...
Even \emph{documentation} and \emph{refactoring} are important while dealing with security; most of the time documentation is neglected because it takes lot of time and it is not payed by the customer. 
