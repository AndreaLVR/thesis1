...
Today we almost trust the security of our Wi-Fi networks, but it has taken a few improvements over the years to get there. The same will happen with ZigBee: more usage will encourage product providers to improve the way security is handled and make it trusted as Wi-Fi is today~\cite{zigbeesmarthomeissues}.\\
