...
So, for all these cases there is only one way to communicate: having a remote MQTT broker on the cloud and let each sensor publishes its own data on it.\\
...
\subsubsection{Frame Protection (PROBABLY TO DELETE)}
\bigskip
